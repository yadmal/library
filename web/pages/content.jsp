...
<%--    <img src="<%=request.getServletContext().getContextPath()%>/PdfContent?index=<%=request.getParameter("index")%>&session_id=<%=request.getSession().getId()%>">--%>
<p>start applet</p>
    <applet CODE="EmbedPDF.class" archive="<%=request.getServletContext().getContextPath()%>/jars/EmbedPDF.jar" WIDTH="850" HEIGHT="900">
